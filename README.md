...
for deploying into ground which deploys website  on icp(web3) as well as internet (web2) for 20 mins
Firt run dfx start in first terminal and then run this command on second terminal :
dfx deploy --playground
by running this command ,you will get a url something   like this :
